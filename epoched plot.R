...
#pdf(file = '/Users/paulthompson/Documents/fTCD_glm_results/Lisa_data/Fixed_HRF/gamma/HRF_signals_plots_LISA_WG_GAM_gamma_Jan2022.pdf', onefile = TRUE) #print plots to file.
my_results_LISA_WG_GAM_gamma_Jan2022<-fTCD_gamma_LISA_GAM(path='/Users/paulthompson/Documents/fTCD_glm_results/Lisa_data/Chpt4_fTCD_WordGen_rawdata',order=order)
#dev.off()
...
#ggsave(file = '/Users/paulthompson/Documents/fTCD_glm_results/Lisa_data/Fixed_HRF/gamma/HRF_signals_plots_LISA_WG_GAM_gamma_correlations_ggally.jpg',width = 10,height = 10,dpi=600)

#jpeg(file = '/Users/paulthompson/Documents/fTCD_glm_results/Lisa_data/Fixed_HRF/gamma/Bland_altman_plots_LISA_WG_GAM_gamma.jpg')
