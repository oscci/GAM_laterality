...
usebdata=1 #if 2, then use unbaselined heartbeatcorrected data, otherwise baselined by epoch
...
plot(summary.data$LI,summary.data$side.interact,col=as.factor(summary.data$lat),main=myr)
