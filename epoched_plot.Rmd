...
```{r run-analysis}
  ...
  summary.data<-data.frame(matrix(NA,nrow=nrow(origWG),ncol=14))
  names(summary.data)<-c('ID',paste0('param',1:5),'LIest.se','method','AIC_glm','AIC_gam','BIC_glm','BIC_gam','p_interaction','R2')
...
gammethods<- c(10) #can have a vector here if need be
...
mym3<-read.csv('method3n_summary.csv')
...
m9<-read.csv("method10n_summary.csv")
