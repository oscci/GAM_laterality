...
for (j in startj:endj){
  ...
  g3<-ggplot(longdata,aes(y=y,x=sec,colour=side))+
    ...
    annotate(geom="text", x=400, y=116, label=paste0("p.interaction=",round(summary.data$p.interaction[j],3)))+
...
myfilename<-paste0(myfilepath,'/','method',gam.method,'_epochplot.csv')
...
#difficult to do in loop!
  m = 3
    ...
    thisfile<-paste0(thisfolder,thisname,'_GAM_epoch.jpg')
...
imageall<-c(image12,image34,image56,image78)
